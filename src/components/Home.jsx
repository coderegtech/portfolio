  ...
  return (
    ...
    >
      <div className=" w-full px-5 ">
        <div className="bg-primary w-full fixed top-0 left-1/2 -translate-x-1/2 z-50 border-b border-white/20 md:px-5">
        ...
        >
          ...
          <div className="max-w-xl h-full w-full md:p-5 bg-black rounded-xl">
            <Skills />
          </div>
        </div>
